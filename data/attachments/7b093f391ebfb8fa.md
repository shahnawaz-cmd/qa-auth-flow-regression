...
- Name: global_auth_flow.spec.ts >> Global Signup & Login Tests >> Auth Signup Test: VSR
...
Received string:  "https://vehiclesreport.com/signup"
Timeout: 30000ms

Call log:
  - Expect "toHaveURL" with timeout 30000ms
    63 × unexpected value "https://vehiclesreport.com/signup"
...
- textbox "Email Address":
  ...
  - text: shahnawaz+lful@empirepixel.com
- text: Password
- textbox "Password":
