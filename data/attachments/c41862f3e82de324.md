...
- Name: global_auth_flow.spec.ts >> Global Signup & Login Tests >> Auth Signup Test: BMW
...
waiting for navigation until "load"
  navigated to "https://bmwwindowsticker.com/signup?email=shahnawaz%2B8p2c%40empirepixel.com&password=PyrWu%5ExZV*%23u&confirmPassword=PyrWu%5ExZV*%23u&phone=7310966145"
============================================================
```
