...
Call log:
  - Expect "toHaveURL" with timeout 30000ms
    56 × unexpected value "https://classicdecoder.com/auth/signup"
...
- main:
  ...
  - textbox "Enter email address*": shahnawaz+xmh5@empirepixel.com
  - button "United States":
    - img "United States"
    - img
  - textbox "Enter phone number": "7826331637"
  - textbox "Enter your password*": TXwVjzhp037P
