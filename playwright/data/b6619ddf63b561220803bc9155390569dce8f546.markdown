...
- Name: global_auth_flow.spec.ts >> Global Signup & Login Tests >> Auth Signup Test: LINCOLN
...
Received string:  "https://lincolnwindowsticker.com/signup"
Timeout: 30000ms

Call log:
  - Expect "toHaveURL" with timeout 30000ms
    63 × unexpected value "https://lincolnwindowsticker.com/signup"
...
- textbox "Email Address":
  ...
  - text: shahnawaz+slo9@empirepixel.com
- img
- text: Password
- textbox "Password":
