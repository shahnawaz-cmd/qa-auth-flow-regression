...
- Name: global_auth_flow.spec.ts >> Global Signup & Login Tests >> Auth Signup Test: DVH
...
Received string:  "https://detailedvehiclehistory.com/signup"
Timeout: 30000ms

Call log:
  - Expect "toHaveURL" with timeout 30000ms
    63 × unexpected value "https://detailedvehiclehistory.com/signup"
...
- textbox "Email Address":
  ...
  - text: shahnawaz+g1xi@empirepixel.com
- img
- text: Password
- textbox "Password":
